// FIX: Import performGeminiAction to interact with the Gemini API.
import { performGeminiAction } from './gemini/aiService';
...
`;
  ...
  // FIX: Use performGeminiAction to make the API call.
